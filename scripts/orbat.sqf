...

{
	...
	_str = _str + format ["<font face='PuristaBold' size='16' color='%2'>%1</font>", groupId _x,_sideColor] + "<br />"; // Format group callsign with side color.

	{
		...
		_str = _str + "  " + _roleIcon + "  " + format ["<font color='%2' face='%3' size ='%4'>%1: </font>", _role, _roleColor,'PuristaMedium',15] + format ["<font  color='%2' face='%3'>%1</font>", (name _x), _teamColor, 'PuristaLight'] + "  " + _rankIcon + "  " + "<br />"; // Combine images, role, and name into one string.
...
orbat = player createDiaryRecord ["Diary", ["ORBAT","<font color='#c96379'>Faction:</font> " + factionName + "<br></br><br></br>" + "<execute expression='execVM ""scripts\orbat.sqf"";'>Refresh</execute>" + "<br></br><br></br>" + _str]]; 