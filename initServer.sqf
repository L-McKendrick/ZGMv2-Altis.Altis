...
_factionList = ["aaf_blu","ana","ana_sf","anp_bp","anp","ada_blu","adp_blu","us_cw_early","us_cw_late","us_cw_late_bo","mdf","mdf_sf","tna_blu","tna_sf_blu","tnp_blu","taki_militia","cdf_blu","cdf_para_blu","ctrg_pac","fia","gendarmerie","hidf","nato","nato_pac","nato_w","us_army_d","us_army_w","us_socom","us_mc_d","us_mc_w","aaf_ind","ada_ind","adpara_ind","adm_ind","adp_ind","ard_ind","chern_militia","chern_police","kdf_ind","medu","medu_sf","medu_sf2","napa","tna_ind","tna_sf_ind","tnp_ind","taki_fighters","un_ind","ldf","saf_sf","saf","saf_early","syndikat","aaf_opf","ada_opf","adp_opf","ade_opf","chdkz","chdkz_winter","chern_commies","ussr_early","ussr_late","ussr_late_vdv","ussr_late_sf","tna_opf","tna_sf_opf","tnp_opf","taki_insurgents","csat","csat_pac","russia_emr","russia_emr_d","russia_sf","tla"];
